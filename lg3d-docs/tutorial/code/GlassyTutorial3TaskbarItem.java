...
public class GlassyTutorial3TaskbarItem extends Tapp {
  ...
  public GlassyTutorial3TaskbarItem()  {
    ...
    try {
      earthApp = new SimpleAppearance(this.getClass().getClassLoader().getResource("earth.jpg"));
    } catch (Exception ex) {
    }
...
//    earthComp.setTranslation(0.0f, 0.0f, -0.01f);
    ...
    top.addListener(
        new MouseClickedEventAdapter(
            new AppLaunchAction("java Tutorial3", getClass().getClassLoader())));
