 ...
 *      7. Compile the code
 *      8. Package the Tutorial to run in LG3D
 *      9. Run the tutorial
 */
...
public class Tutorial2 {
    ...
    public Tutorial2() {
        ...
        // when you create the sphere in order to get it displayed with shadow.
        // Also, the first parameter to Sphere's constructor is specifying
        ...
        Cursor3D cursor = new Cursor3D("Red Ball Cursor", cursorBody);
	...
	// 
        ...
        //
        // Step 8: Package the Tutorial to run in LG3D
        // -------------------------------------------
        ...
        // Edit a file Tutorial2.MF:
        // 
        //     Implementation-Title: Tutorial 2
        //     Main-Class: Tutorial2
        //
        ...
        //     (e.g. java -jar syntax). 
        //     Icon-Filename: The name of an icon can also be provided by 
        //     the parameter Icon-Filename. If this isn't provided a default
        //     icon will be used (/resources/images/icon/defaultapp.png)
        //     from lg3d-cor.jar.
        // 
        // Next we create a jar file using the manifiest file and the
        // Tutorial2.class file, and the tutorial2.png icon file.
        //
        //     jar cmvf Tutorial2.MF Tutorial2.jar Tutorial2.class tutorial2.png
        // 
        // Copy the Tutorial2.jar to $LG3DHOME/ext/app creating the directory
        ...
        //     lg3d/bin/lg3d-dev
        // 
        // Click on the Tutorial2 button. The lg3d desktop should be displayed
        // with a pale green (translucent) box in the center (as you see below).
        // When the mouse is moved over it the cursor should change the movement
        // cursor, and the box should increase in size for have a second.
